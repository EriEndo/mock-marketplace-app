...
<div class="verify-guide">
    ...
    <p class="verify-guide__text">登録していただいたメールアドレスに認証メールを送信しました。<br>メール認証を完了してください。</p>

    <a href="{{ config('services.mailhog.url') }}" target="_blank" rel="noopener" class="verify-guide__button">認証はこちらから</a>
